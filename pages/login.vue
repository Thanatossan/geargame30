<template>
  <div class="w-full max-w-xs log-in">
    <h1 class="block font-bold text-center text-lg" style="font-size:35px">
      Judge Login
    </h1>
    ...
    <div v-on:keyup.enter="login">
      <form class="bg-white rounded px-8 pt-6 pb-8 mb-4 ">
        ...
        Password
          ...
          <input
            v-model="password"
            class="appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none"
            id="password"
            type="password"
